                      ...
                      <td>
                        ...
                        <div class='btn-group'>
                          ...
                          <div class='dropdown-menu' style='border:1px solid #cecece;'>
                            ...
                            <a class='dropdown-item' href='<?= base_url('admin/pesanan_status/') . $row['id_penjualan'] ?>/3' onclick="return confirm('Apa anda yakin untuk ubah status jadi Selesai ?')"> Selesai</a>
                          </div>
                        </div>
                        <?php } ?>
