              ...
              <div class="float-sm-right ">
                ...
                <div class='btn-group'>
                  ...
                  <div class='dropdown-menu' style='border:1px solid #cecece;'>
                    ...
                    <a class='dropdown-item' href='<?= base_url('admin/pesanan_status2/') . $total['id_penjualan'] ?>/3/<?= $this->uri->segment(3) ?>' onclick="return confirm('Apa anda yakin untuk ubah status jadi selesai ?')"> Selesai</a>
                  </div>
                </div>
