  ...
  <div class="row">
    <div class='col-lg-8 col-md-6'>
      <table class="table table-borderless table-sm">
        ...
        <tr>
        <td>
        <small>silahkan ambil di :</small></td>
        <td>
      <label class="text-sm">Jl. Malaka Gg. Sakura No.41, RT.6/RW.6, Munjul, Kec. Cipayung,<br> Kota Jakarta Timur, Daerah Khusus Ibukota Jakarta 13850 <br> (088221111222)</label><br>             
      </td>
        </tr>
      </table>
    </div>
