        ...
        <div class="dashboard">
              ...
              <div class="profile-card__avatar">
                <div class="foto-container">
                  ...
                  <div class="foto-middle">
                    <a href="#" data-toggle="modal" data-target="#uploadfoto" title="Ganti foto" class="btn btn-secondary btn-sm" style="font-size:12px">Ganti Foto
                    </a>
                  </div>
                </div>
              </div>
          ...
          <div class="dashboard__address card address-card address-card--featured">
            ...
            <div class="address-card__body">
              <h6 class="font-weight-bold text-black mb-3">Alamat</h6>
              <?php if ($rows['alamat'] == '') { ?>
