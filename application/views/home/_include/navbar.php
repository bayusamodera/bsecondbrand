                ...
                <div class="mobile-header__panel">
                    <div class="container">
                        <div class="mobile-header__body">
                            <a class="navbar-brand text-white" href="<?php echo base_url();?>"><img src="<?php echo base_url('assets/images/')?>favicon/icon.png" style="width:40px;" class="mr-1"><span class="icon-text"> BSecondBrand </span></a>
                            <button class="mobile-header__menu-button"></button>
                ...
                <div class="site-header__nav-panel">
                    ...
                    <div class="nav-panel nav-panel--sticky" data-sticky-mode="pullToShow">
                        <div class="nav-panel__container container">
                            ...
                            <a class="navbar-brand text-white" href="<?php echo base_url();?>"><img src="<?php echo base_url('assets/images/')?>favicon/icon.png" style="width:40px;" class="mr-1"><span class="icon-text mr-4"> BSecondBrand </span></a>
