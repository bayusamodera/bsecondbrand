...
class Main extends CI_Controller
{
	...
	function index()
	{
		...
		$hrg_awal = $this->input->get('hrg_awal', TRUE);
		$hrg_akhir = $this->input->get('hrg_akhir', TRUE);
		...
		if (is_numeric($dari)) {
			...
			$data['title'] = title();
			$data['record'] = $this->model_app->view_ordering_limit('tb_toko_produk', 'id_produk', 'DESC', $dari = null, $config['per_page'] , $hrg_awal, $hrg_akhir);
